...
PHP_MINIT_FUNCTION(pthreads)
{
	...
	pthreads_stream_entry = zend_register_internal_class_ex(&ce, pthreads_threaded_entry);
	...
	pthreads_stream_context_entry = zend_register_internal_class_ex(&ce, pthreads_threaded_entry);
